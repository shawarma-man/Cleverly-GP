...
class _ForgotWidgetState extends State<ForgotWidget> {
  ApiCallResponse? pwResetRequest;
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'We will send you an email with a pin code to reset your password, please enter the email associated with your account above.',
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    pwResetRequest =
                        await APIBaseGroup.requestPasswordResetCodeCall.call(
                      email: emailAddressController!.text,
                    );
                    _shouldSetState = true;
                    if ((pwResetRequest?.succeeded ?? true)) {
                      context.pushNamed(
                        'pinCode',
                        queryParams: {
                          'email': serializeParam(
