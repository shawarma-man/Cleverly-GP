...
function updateSession(query, update, isOne = true) {
    return __awaiter(this, void 0, void 0, function* () {
        if (isOne)
            return session_model_1.default.updateOne(query, update);
        else
            return session_model_1.default.updateMany(query, update);
    });
}
...
function reIssueAccessToken({ refreshToken, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!session || !session.valid)
            return false;
        const user = yield (0, user_service_1.findUser)({ _id: session.user }, true);
        if (!user)
            return false;
